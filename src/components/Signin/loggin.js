        ...
        <div class="block lg:flex bg-white lg:shadow-lg rounded-lg">
            ...
            <div class="w-full lg:w-2/3 px-6 py-16">
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <input type="password" name="password" id="password" placeholder="Mật khẩu" class="focus:border-blue-500 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none" autocomplete="current-password" required/>
                    </div>
                    ...
                    <Link  class="flex justify-between inline-block mt-4 text-xs text-gray-500 cursor-pointer hover:text-black "  to="/signup"  >Bạn đã có tài khoản? Signup</Link>
